...
SELECT mus.ad, mus.soyadi, sts.satistarihi
FROM tblmusteri mus
         JOIN tblsatis sts ON mus.id = sts.musteriid;

SELECT mus.ad, mus.soyadi, sts.satistarihi, spt.adet
FROM tblmusteri mus
         JOIN tblsatis sts ON mus.id = sts.musteriid
