...
// Tekrar Edenleri İçine Almadı - Sırayı Karıştırdı - Sadece Bir Tane null Değeri Alabilir
        ...
        Set<Integer> myLinkedHashSetList1 = new LinkedHashSet(); // Tekrar Edenleri İçine Almadı - Sırayı Bozmadı
...
// Tekrar Edenleri İçine Almadı - Sırayı Küçükten Büyüğe ve Alfabetik Sıraladı - null Değeri Almaz
        myTreeSetList1.add(55);
        myTreeSetList1.add(10);
        myTreeSetList1.add(10);
        myTreeSetList1.add(33);
        myTreeSetList1.add(22);
        // myTreeSetList1.add(null); // !!! ÖNEMLİ !!! - Sort(Sıralama) Yaptığı İçin null Değeri Almaz
