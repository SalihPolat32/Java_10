...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        myArrayList3.add(null); // 5
        myArrayList3.add(null); // 6
        ...
        myLinkedList1.add(null); // 4
        myLinkedList1.add(null); // 5
        ...
        myVectorList1.add(null); // 4
        myVectorList1.add(null); // 5
        ...
        myStackList1.pop(); // En sondaki değeri çıkardı
        System.out.println(myStackList1);

        myStackList1.remove(2); // İndex'e göre çıkardı
        System.out.println(myStackList1);
