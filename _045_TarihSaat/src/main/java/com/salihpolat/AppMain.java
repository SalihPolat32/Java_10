...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        localDate = LocalDate.of(1996, 4, 8);
        System.out.println(localDate);
        ...
        System.out.println(zonedDateTime + ""); // Böyle Yapma
        ...
        System.out.println("Sonlandırma: " + stop);
        System.out.println("Fark: " + (stop - start));
    }
}